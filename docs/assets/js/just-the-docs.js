(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://aneri12345.github.io/Personal-Log/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://aneri12345.github.io/Personal-Log/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://aneri12345.github.io/Personal-Log/assets/css/just-the-docs-' + theme + ".css"
      );
    };
